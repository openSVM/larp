...
pub struct ToolUseAgentProperties {
    ...
    is_dev_tools_context: bool,
}

impl ToolUseAgentProperties {
    pub fn new(in_editor: bool, repo_name: Option<String>, aide_rules: Option<String>, is_dev_tools_context: bool) -> Self {
        Self {
            _in_editor: in_editor,
            repo_name,
            aide_rules,
            is_dev_tools_context,
        }
    }
}
